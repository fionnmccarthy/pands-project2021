...
# Below I have created two font types that will be used in the plots
font1 = {'family':'serif','color':'darkblue','size':14} 
font2 = {'family':'serif','color':'lightblue','size':12} 



#For plotting the data I will group it into each flower species
...
# Histograms of Data - reference below
...
# I Will create a histogram function with three paramaters to be passed on execution - p1, p2, p3
...
# I Will create a scatterplot function with five paramaters to be passed on execution - p1, p2, p3, p4, p5
...
# Defining execution of scatterplots in the below function and passing in values for p1, p2, p3, p4, p5
def scatterplots():
...
# Pair plots were used in order to compare scatterplots of all the possibloe varaibles
# This was used as to not have to create all individual pairs and a shorted way 
